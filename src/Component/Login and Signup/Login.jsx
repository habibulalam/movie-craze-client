            ...
            <div className="w-full max-w-md p-4 mx-auto mt-5 rounded-md shadow sm:p-8 bg-white text-custom-blue border border-custom-blue">
                ...
                <div className="my-6 space-y-4">
                    <button
                        ...
                        className="hover:cursor-pointer active:scale-95 transition-all duration-300 flex items-center justify-center w-full p-4 space-x-4 border-2 rounded-4xl focus:ring-2 focus:ring-offset-1 focus:ring-default-400 bg-white text-custom-blue hover:bg-custom-orange hover:text-white">
                ...
                <form onSubmit={handleLoginFormSubmit}>
                    <div className="space-y-4">
                        <div className="space-y-2">
                            ...
                            <input type="email" name="email" id="email" placeholder="your@mail.com" className="w-full px-3 py-2 border rounded-md border-gray-700 bg-white text-custom-blue focus:border-default-400 placeholder:text-gray-400"/>
                        </div>
                        <div className="space-y-2">
