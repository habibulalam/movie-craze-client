                        ...
                        <div>
                            {
                                user && (
                                    <div className="flex justify-center items-center gap-3">
                                        <div className="border size-fit border-black rounded-full tooltip tooltip-bottom text-sm" data-tip={user.displayName}><img src={user.photoURL} className="size-11 rounded-full" alt="" /></div>
